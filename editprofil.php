...
<form action="" method="post">
		...
		<tr>
			...
			<td><input class="form-control" type="text" name="username" value="<?php echo $data['username'];?>" required /></td>
		</tr>
		<tr>
			<td>Password</td>
			
			<td><input class="form-control" type="text" name="password" value="<?php echo $data['password'];?>" required /></td>
		</tr>
		<tr>
			<td>Nama lengkap</td>
			
			<td><input class="form-control" type="text" name="nama_user" value="<?php echo $data['nama_user'];?>" required /></td>
		</tr>

		<tr>
			<td></td>
			
			<td><input class="btn btn-info" type="submit" name="edit" value="Edit" />
